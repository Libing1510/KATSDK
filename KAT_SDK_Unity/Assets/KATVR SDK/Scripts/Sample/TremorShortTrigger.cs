...
public class TremorShortTrigger : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.tag == "Player")
        {
            KATVR.KATVR_Global.KDevice_Landform2.TREMOR_SHORT = level;
            Debug.Log("enter TremorShortTrigger " + level);
    ...
    private void Reset()
    {
        ...
        transform.name = "TremorShortTrigger";
        if (!ground)
        {
